...
public class MainActivity extends AppCompatActivity {
    ...
    private void requestLocationPermission() {
        ActivityResultLauncher<String[]> locationPermissionRequest = registerForActivityResult(
                new ActivityResultContracts.RequestMultiplePermissions(), result -> {
                    ...
                    Boolean coarseLocationGranted = result.getOrDefault(Manifest.permission.ACCESS_COARSE_LOCATION,
                            false);
    ...
    private void setValuesforPage() {
        ...
        temperatureTextView.setText(weatherData.getCurrent().getTemperature() + "°C");

        // Info Adiccional
        TextView humidityTextView = findViewById(R.id.humidityTextView);
        humidityTextView.setText(weatherData.getCurrent().getHumidity() + "%");
    ...
    // Establece el nombre de la ciudad una vez se tiene la ubicacion en el string
    //////// cityName
    ...
    // establece el icono en concordancia con el weathercode recibido y al momento
    // del dia que sea
